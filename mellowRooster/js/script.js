...
work1TextAnimation.from("#sectionNumber1TitleBottom", 0.5, {x: -50, opacity: 0}, "-=0.6");
work1TextAnimation.from("#rnCenter", 0.5, {opacity: 0, y: -50}, "-=0.6");
...
workAreaImageScrollAnimation.from("#rnLeft", 5, { opacity: 0, x: 100});
workAreaImageScrollAnimation.from("#rnRight", 5, { opacity: 0, x: -100 }, "-=5");
...
work2TextAnimation.from("#brochure", 0.5, {opacity: 0})
...
work3TextAnimation.from(".brandingImage", 1, {opacity: 0});
...
if(isMobile ==  true){
  ...
  work3AreaScrollAnimationMob.to("#rnLoop", 1, {y: 200}, "-=1");
